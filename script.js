...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="samber"  id="Chapathi"  name="option"/>
  <label class="form-check-label" for="ChickenBiriyani"> Chicken Biriyani </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="dosa"  id="veg biriyani"  name="option" />
  <label class="form-check-label" for="MuttonBiriyani"> Mutton Biriyani </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="fish Fry"  id="matten Fry"  name="option" />
  <label class="form-check-label" for="Chicken cury"> lalipop </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value=" Noodles"  id="fraid raise"  name="option" />
  <label class="form-check-label" for="gril chicken"> thanthuri </label>
</div>
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="Chicken Rice"  id="veg Rice"  name="option" />
    <label class="form-check-label" for="magi"> nodels </label>
</div>`;
form1.append(f_div6);
